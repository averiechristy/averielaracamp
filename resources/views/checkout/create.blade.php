                        ...
                        <form action="{{route('checkout.store', $camp->id)}}" class="basic-form" method="POST">
                            ...
                            <form action="#" class="basic-form">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input name="card number" type="number" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                                </div>
                                <div class="mb-5">
                                    <div class="row">
                                        <div class="col-lg-6 col-12">
                                        ...
                                        <div class="col-lg-6 col-12">
                                            ...
                                            <input name="cvc" type="text" class="form-control" maxlength="3" id="exampleInputEmail1" aria-describedby="emailHelp">
                                        </div>
                                    </div>
                                </div>
